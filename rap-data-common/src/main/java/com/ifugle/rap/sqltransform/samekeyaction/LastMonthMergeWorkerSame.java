 ...
 * @date 2022/1/7 11:11
 */
public class LastMonthMergeWorkerSame extends SameKeyAction<IndexDayModel> {


    public LastMonthMergeWorkerSame(KeySelector<IndexDayModel> indexDayModelKeySelector) {
