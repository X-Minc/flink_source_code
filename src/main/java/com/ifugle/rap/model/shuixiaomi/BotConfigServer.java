...
public class BotConfigServer extends EnhanceModel<Long> {
     ...
     * 是否需要建立推荐关联（1=是，0=否）
     *
     * @param enabledForecast
     *            the enabledForecast to set
     */
    ...
    public boolean equals(Object obj) {
        ...
        return (this.getType() == null ? other.getType() == null : this.getType().equals(other.getType())) && (this.getName() == null ?
                other.getName() == null :
                this.getName().equals(other.getName())) && (this.getShortName() == null ? other.getShortName() == null : this.getShortName().equals(other.getShortName())) && (
                this.getParentId() == null ? other.getParentId() == null : this.getParentId().equals(other.getParentId())) && (this.getDefaultNodeId() == null ?
                other.getDefaultNodeId() == null :
                this.getDefaultNodeId().equals(other.getDefaultNodeId())) && (this.getOrgId() == null ? other.getOrgId() == null : this.getOrgId().equals(other.getOrgId())) && (
                this.getAllowGuest() == null ? other.getAllowGuest() == null : this.getAllowGuest().equals(other.getAllowGuest())) && (this.getAuthVendor() == null ?
                other.getAuthVendor() == null :
                this.getAuthVendor().equals(other.getAuthVendor())) && (this.getAppId() == null ? other.getAppId() == null : this.getAppId().equals(other.getAppId())) && (this.getAppKey() == null ?
                other.getAppKey() == null :
                this.getAppKey().equals(other.getAppKey())) && (this.getAppSecret() == null ? other.getAppSecret() == null : this.getAppSecret().equals(other.getAppSecret())) && (
                this.getBaseUrl() == null ? other.getBaseUrl() == null : this.getBaseUrl().equals(other.getBaseUrl())) && (this.getAuthUrl() == null ?
                other.getAuthUrl() == null :
                this.getAuthUrl().equals(other.getAuthUrl())) && (this.getEnabledForecast() == null ? other.getEnabledForecast() == null : this.getEnabledForecast().equals(other.getEnabledForecast()))
                && (this.getLevel() == null ? other.getLevel() == null : this.getLevel().equals(other.getLevel())) && (this.getRecommendTips() == null ?
                ...
                this.getKnowledgeTips().equals(other.getKnowledgeTips())) && (this.getRemark() == null ? other.getRemark() == null : this.getRemark().equals(other.getRemark())) && (
                this.getVisible() == null ? other.getVisible() == null : this.getVisible().equals(other.getVisible())) && (this.getEnabled() == null ?
